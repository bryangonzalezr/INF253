...
public class Mago extends Jugador{
    ...
    //Crea un Jugador tipo Mago, con las estadisticas iniciales propias del//
    //Mago. Ademas, recibe un Scanner, esto para poder hacer los inputs luego//
    //y cerrar satisfactoriamente el System.in //
    public Mago(String nombre, Scanner input){
    ...
    //del Mago. En caso de que no tenga energia, su valor siempre es 0//
    ...
    public int ataque(){
        ...
        if (this.getEnergia()==0) {
            ...
            int div = this.getInteligencia()/4;
            damage= (this.getFuerza()*div)+this.getEnergia();
        }
    ...
    //aumentan los atributos del Mago, ademas de elevar al maximo actual todos los atributos//
    @Override
